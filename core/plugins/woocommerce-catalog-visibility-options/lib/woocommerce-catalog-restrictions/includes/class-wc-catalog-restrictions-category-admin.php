...
class WC_Catalog_Restrictions_Category_Admin {
	...
	function category_field_save( $term_id, $tt_id, $taxonomy ) {
		...
		update_woocommerce_term_meta(  $term_id,'_wc_restrictions_purchase', $purchase_roles_allowed );
		if ( $purchase_roles_allowed == 'inherit' ) {
			delete_woocommerce_term_meta(  $term_id,'_wc_restrictions_purchase_roles' );
			...
			update_woocommerce_term_meta(  $term_id,'_wc_restrictions_purchase_roles', $proles );
			delete_woocommerce_term_meta(  $term_id,'_wc_restrictions_purchase_locations' );
			...
			update_woocommerce_term_meta(  $term_id,'_wc_restrictions_purchase_locations', $plocations );
			delete_woocommerce_term_meta(  $term_id,'_wc_restrictions_purchase_roles' );
		}


		$price_roles_allowed = filter_input( INPUT_POST, '_wc_restrictions_price' );
		update_woocommerce_term_meta(  $term_id,'_wc_restrictions_price', $price_roles_allowed );
		if ( $price_roles_allowed == 'inherit' ) {
			delete_woocommerce_term_meta(  $term_id,'_wc_restrictions_price_roles' );
			...
			update_woocommerce_term_meta(  $term_id,'_wc_restrictions_price_roles', $proles );
			delete_woocommerce_term_meta(  $term_id,'_wc_restrictions_price_locations' );
			...
			update_woocommerce_term_meta(  $term_id,'_wc_restrictions_price_locations', $plocations );
			delete_woocommerce_term_meta(  $term_id,'_wc_restrictions_price_roles' );
		}
